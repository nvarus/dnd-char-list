...
<form action="/src/php/create/create-char-handler.php" method="post">
	...
	<div class="specifications">
		...
		<div class="specWrap">
			...
			<div class="skills">
					<div><input type="checkbox" id="strSaveThrow"> <span>Спасбросок</span></div>
					<div><input type="checkbox" id="athletics"> <span>Атлетика</span></div>
					<div><input type="checkbox" id="intimidation"> <span>Запугивание</span></div>
